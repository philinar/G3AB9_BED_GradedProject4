...
<body>
	<div class="container">
		...
		<form action="/employeemgmtrestapi/employee/search" class="form-inline">

			<!-- Add a button -->
			<a href="/employeemgmtrestapi/employee/showform"
				class="btn btn-primary btn-sm mb-3"> Add Employee </a> 
			<a href="/employeemgmtrestapi/logout" 
				...
				<c:forEach items="${Employees}" var="tempEmployee">
					<tr>
						...
						<td>
							...
							<a href="/employeemgmtrestapi/employee/showFormForUpdate?EmployeeId=${tempEmployee.id}"
							class="btn btn-info btn-sm"> Update </a> 
							<!-- Add "delete" button/link -->
							<a href="/employeemgmtrestapi/employee/delete?EmployeeId=${tempEmployee.id}"
